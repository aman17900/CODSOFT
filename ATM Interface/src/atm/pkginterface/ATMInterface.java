...
public class ATMInterface extends JFrame {
    ...
    public ATMInterface() {
        ...
        getContentPane().setBackground(new Color(1,0, 1));
        setLayout(null);
        ...
        checkBalance.setBackground(new Color(70,119, 255));
